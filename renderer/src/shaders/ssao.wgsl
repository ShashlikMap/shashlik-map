...
const kernel = array<vec3f, samples>(
        vec3f(-0.572696f, -0.614621f, 0.007059f),
        vec3f(0.794827f, 0.224453f, -0.406284f),
        vec3f(0.095833f, 0.688492f, 0.501733f),
        vec3f(0.382093f, 0.300001f, -0.681495f),
        vec3f(-0.001121f, 0.464844f, -0.686406f),
        vec3f(0.621404f, -0.573571f, -0.040475f),
        vec3f(0.430238f, -0.891202f, -0.547375f),
        vec3f(-0.559723f, 0.697702f, 0.743278f),
    );
