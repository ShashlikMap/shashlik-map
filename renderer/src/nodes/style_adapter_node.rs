...
use wgpu::{BindGroup, BindGroupLayout, CompareFunction, Device, Queue, RenderPass};
...
impl<T: SceneNode> SceneNode for StyleAdapterNode<T> {
    ...
    fn update(&mut self, device: &Device, _queue: &Queue) {
    ...
    fn render(&self, render_pass: &mut RenderPass) {
        ...
        self.scene_node.render(render_pass);
    }
}
